...
typedef int (*fsck_error)(struct fsck_options *o, struct object *obj, int type,
			  const char *message);

int fsck_error_function(struct fsck_options *o, struct object *obj, int type,
			const char *message);
...
#define FSCK_OPTIONS_DEFAULT                       \
	{                                          \
		NULL, fsck_error_function, 0, NULL \
	}
#define FSCK_OPTIONS_STRICT                        \
	{                                          \
		NULL, fsck_error_function, 1, NULL \
	}
