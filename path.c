...
static struct common_dir common_list[] = { { 0, 1, 0, "branches" },
					   { 0, 1, 0, "hooks" },
					   { 0, 1, 0, "info" },
...
static void
update_common_dir(struct strbuf *buf, int git_dir_len, const char *common_dir)
{
...
static void
strbuf_worktree_gitdir(struct strbuf *buf, const struct repository *repo,
