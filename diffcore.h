...
extern void fill_filespec(struct diff_filespec *, const struct object_id *, int,
			  unsigned short);
...
diff_queue(struct diff_queue_struct *, struct diff_filespec *,
	   struct diff_filespec *);
...
extern int
diffcore_count_changes(struct diff_filespec *src, struct diff_filespec *dst,
