...
struct http_get_options {
	unsigned no_cache : 1, keep_error : 1, initial_request : 1;
...
extern int
http_get_info_packs(const char *base_url, struct packed_git **packs_head);
...
extern struct http_pack_request *
...
extern struct http_object_request *
